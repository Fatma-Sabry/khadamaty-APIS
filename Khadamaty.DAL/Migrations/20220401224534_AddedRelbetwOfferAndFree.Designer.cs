...
namespace Khadamaty.DAL.Migrations
{
    ...
    [Migration("20220401224534_AddedRelbetwOfferAndFree")]
    partial class AddedRelbetwOfferAndFree
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Khadamaty.DAL.Entity.Freelancecs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Khadamaty.DAL.Entity.ClientFreelance", b =>
                {
                    ...
                    b.HasOne("Khadamaty.DAL.Entity.Freelancecs", null)
                        .WithMany("clients")
            ...
            modelBuilder.Entity("Khadamaty.DAL.Entity.Freelancecs", b =>
                {
                    b.HasOne("Khadamaty.DAL.Entity.Offer", "Offer")
                        .WithOne("Freelancecs")
                        .HasForeignKey("Khadamaty.DAL.Entity.Freelancecs", "OfferId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Khadamaty.DAL.Entity.Rating", b =>
                {
                    ...
                    b.HasOne("Khadamaty.DAL.Entity.Freelancecs", "Freelancecs")
                        .WithMany("Ratings")
                        .HasForeignKey("FreelancecsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
